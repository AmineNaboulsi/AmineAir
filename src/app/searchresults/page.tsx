    ...
    <div>
     ...
     <section className="bg-white">
      ...
      <section className='mt-10'>
        <div className="container">
          <div className="">
                <div className="flex jus items-center gap-4 text-lg">
                            <FaPlaneDeparture />
               ...
               <div className="bg-white grid grid-cols-[auto,1fr,1fr] p-7 mt-3">
                <div className="flex w-32 flex-col justify-center items-center mr-3 border-r-2 ">
                ...
                <div className="grid grid-cols-2 grid-rows-[auto,1fr] px-5 gap-3">
                    ...
                    <div className="flex flex-col text-end">
                      ...
                      <span className='text-2xl font-semibold'>1.519,10 Dhs Dhs</span>
                    </div>
